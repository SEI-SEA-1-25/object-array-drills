...
const labelAlbum1 = album1.albumDetails.label;
//console.log(labelAlbum1)
...
album3.albumDetails.released = new Date('August 3, 1979');  <---CONFUSION
...
band.property.members.push("Tiny Weymouth" , "Chris Franz" , "Jerry Harrison");
//console.log(band.property.members);
...
//talkingHeadsAlbums = 9

if (talkingHeadsAlbums%2 === 0) {
  console.log("The number " + talkingHeadsAlbums + " is even!");
} else {
  console.log("The number " + talkingHeadsAlbums + " is odd!");
}
*/
...
const talkingHeadsAlbums = ["album1" , "album2" , "album3" , "album4" , "album5" , "album6" , "album7" , "album8", "album9" , "album10" , "album11" , "album12"];
let amountOfAlbums = talkingHeadsAlbums.length;
//console.log(amountOfAlbums);
if (amountOfAlbums%2 === 0 && amountOfAlbums%3 === 0) {
  console.log("The number " + amountOfAlbums + " is divisible by 2 and 3.");
} else if (amountOfAlbums%2 !== 0 && amountOfAlbums%3 !== 0) {
  console.log("The number " + amountOfAlbums + " is not divisible by 2 or 3.");
} else if (amountOfAlbums%2 === 0) {
  console.log("The number " + amountOfAlbums +  " is divisible by 2.");
} else if (amountOfAlbums%3 === 0) {
  console.log("The number " + amountOfAlbums + " is divisble by 3");
} 

// 4. Check your logic above against the numbers: 0, 1, 2, 6, 7, and 9.
//    Make sure it always works! _DONE
...
for (guest of tickets) {
    ...
    if (guest.seats === 1) {
        ...
        welcomeStr += " You & your party may sit anywhere";
    }
