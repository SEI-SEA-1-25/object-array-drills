...
let transfer = album2.albumDetails.formats[0]
album3.albumDetails.formats.push(transfer)
console.log(album3.albumDetails.formats)

// album3.albumDetails.formats.push(album2.albumDetails.formats[0])     <-- fundamentals
...
// 7. Make the label "emi" in album6 all uppercase ////////////////// <--- help
// google how to make a string uppercase in js!
let makeUpper = album6.albumDetails.labels[1]
makeUpper.toUpperCase()
...
Y = talkingHeadsAlbums.length

divisableByTwo = Y % 2
divisableByThree = Y % 3

if (divisableByTwo == 0 && divisableByThree == 0) {
  console.log("The number " + Y + " is divisable by 2 and 3")
} else if (divisableByThree == 0) {
  console.log("The number Y is divisible by 3")
} else if (divisableByTwo == 0) {
  console.log("The number Y is divisible by 2")
} else {
  console.log("no")
}
//understood the concept, just different bc i couldn't copy&paste everything, and make things easier
...
// 1. Use a for loop to print out the name of each Talking Heads album
  for (let i = 0; i < talkingHeadsAlbums; i++){
