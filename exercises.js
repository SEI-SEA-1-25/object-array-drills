...
//    variable.
let labelInfo = album1.albumDetails.label;
...
let formats = album2.albumDetails.formats;
album3.albumDetails.formats.push(formats);
...
let numbAlb = talkingHeadsAlbums.length;
if (talkingHeadsAlbums.length % 2 == 0) {
  console.log("The number" + numbAlb + "is odd");
} else {
  console.log("The number" + numbAlb + "is even");
}
...
if (numbAlb % 2 === 0 && numbAlb % 3 === 0) {
    console.log("The number" + numbAlb + "is divisible by 2 and 3");
} else if (numbAlb % 2 === 0) {
  console.log("The number" + numbAlb + "is divisible by 2");
} else if (numbAlb % 3 === 0) {
  console.log("The number" + numbAlb + "is divisible by 3");
} else if (numbAlb === 0) {
  console.log("The number" + numbTAlb + "is not divisible by 2 and 3");
}
...
for(guest of tickets) {
  let welcomeMsg = `Welcome, ${guest.name}!`;

  if(guest.seats === 1) {
      welcomeMsg += " You may sit anywhere"
  } else {
      welcomeMsg += " You and your party may sit anywhere"
  }

  if(guest.type === 'premium') {
      welcomeMsg += ` in the first 3 rows of the ${guest.section} section.`
  } else {
      welcomeMsg += ` except the first 3 rows of the ${guest.section} section.`
  }
