...
band.members.push("Tiny Weymout", "Chris Franz", "Jerry Harrison");
...
var numberOfAlbums = talkingHeadsAlbums.length;
...
if(numberOfAlbums % 2 === 0 ){
  console.log("The number", numberOfAlbums, "is divisivle by 2");
}else if(numberOfAlbums % 3 === 0){
  console.log("The number", numberOfAlbums, "is divisible by 3");
}else if(numberOfAlbums % 3 && numberOfAlbums % 2 === 0){
