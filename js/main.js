...
const album1 = {
  ...
  album3.albumDetails.released = new Date(08/03/1979);
  ...
  album4.albumDetails.donut = "Sprinkles";
  console.log(album4.albumDetails.donut);
  console.log(album4);
  ...
  console.log(album5.albumDetails.formats[0]);
  console.log(album5.albumDetails.formats.join(' | '));
  ...
  /* NOTE TO SELF: album6.albumDetails.labels[1].toUpperCase(); 
  the above won't work. You need to use the 
  assignment operator and set it equal to istelf with the .toUpperCase() method
  */
